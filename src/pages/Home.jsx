        ...
        <div>
            ...
            <section className="features-container">
                ...
                <div className="features-responsive">
                    <div className="feature-1" onClick={() => showFeature("feature1")}>
                        <h3>Razor Sharp</h3>
                        <p style={isFeatureActive[0].isActive ? featureVisible : null}>The sharpness of the blade allows for clean, precise cuts that preserve the integrity of the food being prepared. Great precision and control when cutting.</p>
                    </div>
                    <div className="feature-2" onClick={() => showFeature("feature2")}>
                        <h3>Comfortable</h3>
                        <p style={isFeatureActive[1].isActive ? featureVisible : null}>Our knives handles provide a comfortable grip and help prevent hand fatigue during extended use.</p>
                    </div>
                    <div className="feature-3" onClick={() => showFeature("feature3")}>
                        <h3>Handcrafted</h3>
                        <p style={isFeatureActive[2].isActive ? featureVisible : null}>Handcrafted using traditional techniques. Each knife is unique and reflects the skill and artistry of the bladesmith</p>
                    </div>
                    <div className="feature-4" onClick={() => showFeature("feature4")}>
                        <h3>Durable</h3>
                        <p style={isFeatureActive[3].isActive ? featureVisible : null}>Made of hard, high-carbon steel that lasts longer than other types of steel. This steel is also more resistant to corrosion, making it an ideal material for kitchen knives.</p>
                    </div>
                </div>
            </section>
